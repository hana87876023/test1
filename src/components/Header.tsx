...
const Header = () => {
  ...
  const navigation = [
    { name: 'ホーム', href: '/' },
    { name: '観光方法', href: '/how-to-travel' },
    { name: '電車ガイド', href: '/train-guide' },
    { name: '文化', href: '/culture-differences' },
    { name: '地域別', href: '/areas' },
  ]
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-taiwan-ocean">台湾旅行ガイド</span>
            </Link>
          </div>
